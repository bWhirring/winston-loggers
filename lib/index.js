...
var Log = /** @class */ (function () {
    ...
    Log.prototype.init = function (params) {
        var filename = params.filename, datePattern = params.datePattern, zippedArchive = params.zippedArchive, maxSize = params.maxSize, maxFiles = params.maxFiles, exceptions = params.exceptions, exceptionsFile = params.exceptionsFile;
        // @ts-ignore
        var opts = {
        ...
        if (exceptions) {
            logger.exceptions.handle(new winston_1.transports.File({ filename: exceptionsFile }));
        }
